...
export function exportSTL(geometry: THREE.BufferGeometry, filename = "3d_print_generator.stl") {
...
export async function export3MF(
  ...
  filename = "3d_print_generator.3mf",
  params?: HookParams,
) {
  const posAttr = geometry.getAttribute("position") as THREE.BufferAttribute
  const triangleCount = posAttr.count / 3
  ...
  const paramComment = params
    ? `<!-- Generated by 3d-print-generator. Params: ${JSON.stringify(params)} -->\n  `
    : ""
